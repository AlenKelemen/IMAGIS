 ...
 * @param {string} options.dialogClassName class name of legend dialog
...
export default class Legend extends Control {
  constructor(options = {}) {
    ...
    this.content.element.className = options.dialogClassName || "legend ol-control";
