...
export default class Legend extends Toggle {
  ...
  addItem(prop) {
    ...
    const header = elt('header', {className: `${this.className}-items-item-header`},thematic);
    ...
    const item = elt('section', {className: `${this.className}-items-item`},header,article,footer);
